...
| `ai9_frontier_readout.py` | verify §1, Table 1 (confirmatory E-series, five clean frontier-generation arms). |
...
| `fig1_compliance_by_persona.py` | Figures: `docs/pilots/figures/fig1_*`, compliance by persona. |
| `fig2_reasoning_forest.py` | Figures: `docs/pilots/figures/fig2_*`, R1 forest plot. |
...
| `ai5_validate_and_readout.py` | `docs/pilots/2026-09-02-dress-rehearsal.md` (log validation and per-model readout); its `mean` helper and load pattern are also reused by `ai16_fusion_readout.py` and `ai31_tier_table.py`. |
| `ai16_fusion_readout.py` | `docs/pilots/2026-09-03-fusion-readout.md`. |
